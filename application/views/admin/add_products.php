...
<script src="//cdn.ckeditor.com/4.14.1/standard/ckeditor.js"></script>
  ...
  <div class="col-xl-12 col-lg-12">
         <div class="card shadow mb-4">
            ...
            <div class="form-row">
                  ...
                  <div class="form-group">
                    ...
                    name="brand_name" value="ZARA" readonly/>                    
                  </div>
                </div>
                ...
                <div class="col-8 p-3">
                    ...
                    name="article_no" placeholder="A981YUZQ">
                    <span id="error" style="font-size: 14px;" class="text-danger"></span>
                  </div>
                ...
                <div class="col-8 p-3">
                    ...
                    <input class="form-control" name="product_short_description" type="text" placeholder="Default input">
                  </div>
                </div>
                ...
                <label for="product-title">Product Image</label>
                  ...
                  <!-- <input type="file" id="files" name="files[]" multiple /> -->
                    ...
                    <div class="card mx-2">
                <h5 class="card-header">Add Product Variation</h5>
                <div class="card-body">
                  <!-- <h5 class="card-title">Special title treatment</h5> -->
                  <!-- row 1 size,color,stock -->
                  <div class="row">
                    <div class="col">
                    <div class="form-group">
      ...
      <div class="col">
        <label data-toggle="tooltip" data-placement="right" title="Must be more then 5 Character">Quantity(Stock)</label>
                    <input type="text" class="form-control" id="product_quantity"   
                    name="product_quantity" placeholder="Eg. 18">
    ...
    <div class="row">
      ...
      <label data-toggle="tooltip" data-placement="right" title="Must be more then 5 Character">MRP</label>
                    ...
                    name="product_mrp" placeholder="Eg. 18">
        </div>
      </div>
      <div class="col">
      <div class="form-group">
      <label data-toggle="tooltip" data-placement="right" title="Must be more then 5 Character">Selling Price</label>
                    ...
                    name="product_selling_price" placeholder="Eg. 18">
                  </div>
      </div>
      <div class="col">
        <label data-toggle="tooltip" data-placement="right" title="Must be more then 5 Character">Discount(%)</label>
                    ...
                    name="discount_percentage" placeholder="Eg. 18">
