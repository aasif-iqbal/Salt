            ...
            <form  action="<?= base_url('store-colored-image'); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="col">
                    <div class="form-group">
                      ...
                      <span>Avilable color variation</span>
                        <label for="exampleFormControlSelect1">Choose Product Color</label>
                            ...
                            ?>
                            <option value='<?= $color->product_color.'_'.$color->product_color_name; ?>'><?= $color->product_color_name; ?></option>
                            <?php endforeach; } ?>                 
                            </select>
                      </div>
                  </div>
