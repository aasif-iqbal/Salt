            ...
            <div class="card shadow mb-4">
                ...
                <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-3" action="<?= base_url('Admin/Admin_Controller/getParentInfo'); ?>" method="POST">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="parent_cat_name" id="" placeholder="Main-Menu">
                                            </div>
                                            <div class="col-auto">
                    ...
                    <form class="row g-3" action="<?= base_url('Admin/Admin_Controller/getChildInfo'); ?>" method="POST">
                        ...
                        <select class="custom-select" name="fk_parent_id">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="child_category_name" id="" placeholder="Sub-Menu">
                    </div>
                    <div class="col-auto">
                        <button type="submit" class="btn btn-primary mb-3">Add children</button>
                    </div>
                </form>
